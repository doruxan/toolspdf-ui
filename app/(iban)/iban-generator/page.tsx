            ...
            <div className="prose prose-gray max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                <div className="p-4 bg-blue-50 rounded">
                  <h4 className="font-semibold text-blue-900 mb-2">🧪 Software Testing</h4>
                ...
                <div className="p-4 bg-green-50 rounded">
                  <h4 className="font-semibold text-green-900 mb-2">🔧 API Development</h4>
                ...
                <div className="p-4 bg-orange-50 rounded">
                  <h4 className="font-semibold text-orange-900 mb-2">✅ Form Validation</h4>
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2 mb-6">
                <li><strong>Valid Checksums:</strong> All generated IBANs pass MOD-97 validation</li>
                ...
                <li><strong>Custom Codes:</strong> Specify bank and branch codes or randomize</li>
                <li><strong>Export Options:</strong> Download as CSV or JSON for easy integration</li>
                <li><strong>Copy Functions:</strong> Copy individual IBANs or all at once</li>
              </ul>
